...
?>
<button type="button" class="btn btn-success" onclick="window.open('ITRtocsv.php?brgy=<?php echo $barangay;?>')" style="float: right;">Export as CSV</button> 
<div class="row">
    <div class="col-xs-12">
        <div class="box">
            ...
            <div class="box-content no-padding">
                <table class="table table-bordered table-striped table-hover table-heading table-datatable" id="datatable-3">
                    ...
                    $id = $_SESSION['userid'];
                        ...
                        $sqlrow = mysqli_fetch_array($sqlresult);
                        $barangay = $sqlrow['barangay'];
                                    $sql = "SELECT patient_enrollment.family_serial_no, name.lname, name.fname, name.mname, contact_info.home_no, contact_info.street,contact_info.barangay, contact_info.city, indiv_treat_rec.itr_id, for_chu_rhu.date_consultation from indiv_treat_rec inner join patient_enrollment inner join name inner join contact_info inner join for_chu_rhu on for_chu_rhu.fcr_id=indiv_treat_rec.fcr_id and contact_info.ci_id=patient_enrollment.ci_id  and contact_info.barangay='$barangay' and name.n_id=patient_enrollment.n_id and patient_enrollment.pe_id=indiv_treat_rec.pe_id and indiv_treat_rec.status='active';";
